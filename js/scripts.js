window.mr = window.mr || {}, mr = function (a, b, c, d) {
    ...
    a = a || {};
    var g = {documentReady: [], documentReadyDeferred: [], windowLoad: [], windowLoadDeferred: []};
    return a.status = {
        documentReadyRan: !1,
        windowLoadPending: !1
    ...
    return a.util = {}, a.util.requestAnimationFrame = c.requestAnimationFrame || c.mozRequestAnimationFrame || c.webkitRequestAnimationFrame || c.msRequestAnimationFrame, a.util.documentReady = function (a) {
        var b = new Date, c = b.getFullYear();
        ...
        var d = b(a), e = d.children().get(), f = -1, g = 1;
        "undefined" != typeof c && (f = 1, g = -1), e.sort(function (a, c) {
            var d = b(a).text(), e = b(c).text();
        ...
        d.each(function (a, c) {
            c = b(c);
            var d = c.attr("src"), e = c.attr("data-src");
    ...
    return a.scroll.update = function (b) {
        ...
        if (a.scroll.y = d ? mr_parallax.mr_getScrollPosition() : c.pageYOffset, a.scroll.busy = !1, d && mr_parallax.mr_parallaxBackground(), a.scroll.listeners.length > 0) for (var e = 0, f = a.scroll.listeners.length; f > e; e++) a.scroll.listeners[e](b);
    ...
    a.scroll.classModifiers = {}, a.scroll.classModifiers.rules = [], a.scroll.classModifiers.parseScrollRules = function (b) {
        var c = b.attr("data-scroll-class"), d = c.split(";");
    ...
    return a.accordions = a.accordions || {}, a.accordions.documentReady = function (b) {
        b(".accordion__title").on("click", function () {
            ...
            var a = b(this), c = a.outerHeight(!0);
            a.css("min-height", c);
        ...
        var e = b(a), f = e.closest(".accordion"), g = e.closest("li"), h = d.createEvent("Event"),
            i = d.createEvent("Event");
        if (h.initEvent("panelOpened.accordions.mr", !0, !0), i.initEvent("panelClosed.accordions.mr", !0, !0), g.hasClass("active")) c !== !0 && (g.removeClass("active"), e.trigger("panelClosed.accordions.mr").get(0).dispatchEvent(i)); else if (f.hasClass("accordion--oneopen")) {
        ...
        var e;
        "" !== c && "#" !== c && null === c.match(/#\/.*/) && (e = b(".accordion > li > .accordion__title#" + c.replace("#", "")), e.length && (b("html, body").stop(!0).animate({scrollTop: e.offset().top - 50}, 1200), a.accordions.activatePanel(e, d)));
    ...
    return a.bars = a.bars || {}, a.bars.documentReady = function (a) {
        a('.nav-container .bar[data-scroll-class*="fixed"]:not(.bar--absolute)').each(function () {
            var b = a(this), c = b.outerHeight(!0);
    ...
    return a.countdown = a.countdown || {}, a.countdown.options = a.countdown.options || {}, a.countdown.documentReady = function (b) {
        b(".countdown[data-date]").each(function () {
            var c, d = b(this), e = d.attr("data-date"),
    ...
    return a.forms = a.forms || {}, a.forms.captcha = {}, a.forms.captcha.widgets = [], a.forms.captcha.done = !1, a.forms.documentReady = function (b) {
        a.forms.captcha.widgets = [], b('.input-checkbox input[type="checkbox"], .input-radio input[type="radio"]').each(function (a) {
            var c = b(this), d = c.siblings("label"), e = "input-assigned-" + a;
            ...
            var a = jQuery(this), b = a.closest(".input-number"), c = b.find('input[type="number"]'), d = c.attr("max"),
                e = c.attr("min"), f = 1, g = parseInt(c.val(), 10);
        ...
        } else a.forms.showFormError(g, f, 1e3, 5e3, 500); else "undefined" != typeof o && o !== !1 && f.text(o), n = a.forms.validateFields(k), 1 === n ? a.forms.showFormError(g, f, 1e3, 5e3, 500) : (k.removeClass("attempted-submit"), f.fadeOut(200), m.addClass("btn--loading"), jQuery.ajax({
            type: "POST",
        ...
        if (a = b(a), a.find('.validate-required[type="checkbox"]').each(function () {
            ...
            g.length && b("html, body").stop(!0).animate({scrollTop: g.offset().top - 100}, 1200, function () {
                g.focus();
            });
    ...
    return a.maps = a.maps || {}, a.maps.options = a.maps.options || {}, a.maps.documentReady = function (b) {
        ...
        if (d.querySelector("[data-maps-api-key]") && !d.querySelector(".gMapsAPI") && a("[data-maps-api-key]").length) {
            var b = d.createElement("script"), c = a("[data-maps-api-key]:first").attr("data-maps-api-key");
        ...
        "undefined" != typeof c.google && "undefined" != typeof c.google.maps && (a.maps.instances = [], jQuery(".gmaps-active").each(function () {
            var b, c, e, f, g, h, i, j = this, k = jQuery(this), l = jQuery(d).width() > 766 ? !0 : !1,
                ...
                o = n ? 1 * n.substr(0, n.indexOf(",")) : !1, p = n ? 1 * n.substr(n.indexOf(",") + 1) : !1,
                q = new google.maps.Geocoder,
                r = "undefined" != typeof k.attr("data-address") ? k.attr("data-address").split(";") : [""], s = {},
                t = {};
            i = d.createEvent("Event"), i.initEvent("mapCreated.maps.mr", !0, !0), f = {
                ...
                zoom: 17,
                zoomControl: !1
            }, s.styles = "undefined" != typeof k.attr("data-map-style") ? JSON.parse(k.attr("data-map-style")) : void 0, s.zoom = k.attr("data-map-zoom") ? parseInt(k.attr("data-map-zoom"), 10) : void 0, s.zoomControlOptions = m !== !1 ? {position: google.maps.ControlPosition[m]} : void 0, e = {
                icon: {
                    url: ("undefined" != typeof mr_variant ? "../" : "") + "img/mapmarker.png",
                    scaledSize: new google.maps.Size(50, 50)
                }, title: "We Are Here", optimised: !1
            }, t.icon = "undefined" != typeof k.attr("data-marker-image") ? k.attr("data-marker-image") : void 0, t.title = k.attr("data-marker-title"), g = jQuery.extend({}, f, a.maps.options.map, s), h = jQuery.extend({}, e, a.maps.options.marker, t), void 0 !== r && "" !== r[0] ? q.geocode({address: r[0].replace("[nomarker]", "")}, function (c, d) {
                d === google.maps.GeocoderStatus.OK && (b = new google.maps.Map(j, g), a.maps.instances.push(b), jQuery(j).trigger("mapCreated.maps.mr").get(0).dispatchEvent(i), b.setCenter(c[0].geometry.location), r.forEach(function (a) {
                    ...
                    if (/(\-?\d+(\.\d+)?),\s*(\-?\d+(\.\d+)?)/.test(a)) var d = a.split(","),
                        e = new google.maps.Marker(jQuery.extend({}, h, {
                            ...
                            map: b
                        })); else a.indexOf("[nomarker]") < 0 && (c = new google.maps.Geocoder, c.geocode({address: a.replace("[nomarker]", "")}, function (a, c) {
    ...
    return a.masonry = a.masonry || {}, a.masonry.documentReady = function (b) {
        a.masonry.updateFilters(), b(d).on("click touchstart", ".masonry__filters li:not(.js-no-action)", function () {
            var a = b(this), c = a.closest(".masonry").find(".masonry__container"), d = "*";
        ...
        var d = b(c);
        d.each(function () {
            var c, d = b(this), e = d.find(".masonry__container"), f = d.find(".masonry__filters"),
            ...
            d.is(".masonry") && e.find(".masonry__item[data-masonry-filter]").length && (c = f.find("> ul"), c.length || (c = f.append("<ul></ul>").find("> ul")), e.find(".masonry__item[data-masonry-filter]").each(function () {
                var d = b(this), e = d.attr("data-masonry-filter"), f = [];
        ...
        var c = b(a);
        c.each(function () {
            var a = b(this), c = a.find(".masonry__item:not([style])"), d = a.find(".masonry__container");
    ...
    return a.modals = a.modals || {}, a.modals.documentReady = function (b) {
        var e = '<div class="all-page-modals"></div>', f = b("div.main-container");
        if (f.length ? (jQuery(e).insertAfter(f), a.modals.allModalsContainer = b("div.all-page-modals")) : (jQuery("body").append(e), a.modals.allModalsContainer = jQuery("body div.all-page-modals")), b(".modal-container").each(function () {
            var d = b(this), e = (b(c), d.find(".modal-content"));
            ...
            var d = b(this), e = d.find(".modal-container"), f = (d.find(".modal-content"), d.find(".modal-trigger"));
            ...
            var c = b(this), d = 1 * c.attr("data-autoshow");
            ...
            var c = jQuery(this), e = c.attr("data-show-on-exit"), f = 0;
        ...
        var e = "undefined" != typeof c ? 1 * c : 0, f = b(a);
        ...
        var b = jQuery("body div.modal-active"), e = d.createEvent("Event");
    ...
    return a.notifications = a.notifications || {}, a.notifications.documentReady = function (b) {
        b(".notification").each(function () {
            ...
            var c = b(this), d = parseInt(c.attr("data-autoshow"), 10);
        ...
        var e = jQuery(b), f = "undefined" != typeof c ? 1 * c : 0, g = d.createEvent("Event");
        ...
        var e = jQuery(c), f = d.createEvent("Event");
    ...
    return a.parallax = a.parallax || {}, a.parallax.documentReady = function (a) {
        var b = a(c), d = b.width(), e = b.height(), f = a("nav").outerHeight(!0);
        if (d > 768) {
            var g = a(".parallax:nth-of-type(1)"), h = a(".parallax:nth-of-type(1) .background-image-holder");
    ...
    return a.progressHorizontal = a.progressHorizontal || {}, a.progressHorizontal.documentReady = function (a) {
        ...
        a(".progress-horizontal").each(function () {
            var a = jQuery(this).find(".progress-horizontal__bar"), c = {},
    ...
    return a.sliders = a.sliders || {}, a.sliders.documentReady = function (b) {
        b(".slider").each(function (c) {
            var d = b(this), e = d.find("ul.slides");
            e.find(">li").addClass("slide");
            var f = e.find("li").length, g = {
                cellSelector: ".slide",
                cellAlign: "left",
                wrapAround: !0,
                pageDots: !1,
    ...
    return a.smoothscroll = a.smoothscroll || {}, a.smoothscroll.sections = [], a.smoothscroll.init = function () {
        a.smoothscroll.sections = [], b("a.inner-link").each(function () {
            var c = {}, d = b(this), e = d.attr("href"), f = new RegExp("^#[^\r\n	\f#.]+$", "gm");
    ...
    return a.tabs = a.tabs || {}, a.tabs.documentReady = function (b) {
        b(".tabs").each(function () {
            ...
            a.after('<ul class="tabs-content">'), a.find("li").each(function () {
                var a = b(this), c = a.find(".tab__content").wrap("<li></li>").parent(), d = c.clone(!0, !0);
        ...
        var c, e = b(a), f = e.closest(".tabs-container"), g = 1 * e.index() + 1,
            h = f.find("> .tabs-content > li:nth-of-type(" + g + ")"), i = d.createEvent("Event");
    ...
    return a.toggleClass = a.toggleClass || {}, a.toggleClass.documentReady = function (a) {
        a("[data-toggle-class]").each(function () {
            var b = a(this), c = b.attr("data-toggle-class").split("|");
            a(c).each(function () {
                var c = b, d = [], e = "", f = "", d = this.split(";");
    ...
    return a.typed = a.typed || {}, a.typed.documentReady = function (b) {
        b(".typed-text").each(function () {
            var c = b(this), d = (c.attr("data-typed-strings") ? c.attr("data-typed-strings").split(",") : [], {
                strings: [],
                typeSpeed: 100,
                loop: !0,
                showCursor: !1
    ...
    return a.video = a.video || {}, a.video.options = a.video.options || {}, a.video.options.ytplayer = a.video.options.ytplayer || {}, a.video.documentReady = function (b) {
        b(".youtube-background").length && b(".youtube-background").each(function () {
            var c = b(this), d = {containment: "self", autoPlay: !0, mute: !0, opacity: 1}, e = {};
            ...
            var a = b(this), c = a.closest(".video-cover");
